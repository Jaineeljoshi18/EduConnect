...
Create a new project named "EduConnect".
Register your Android app using the package name found in your AndroidManifest.xml.
...
Click the Run (green play button) to install the app.
